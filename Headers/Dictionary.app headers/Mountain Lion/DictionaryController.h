...
@class BrowserWindowController, DSShadowOverlay, DictionaryRecordRepository, DictionaryWebView, NSArray, NSArrayController, NSMutableArray, NSMutableDictionary, NSOperationQueue, NSScrollView, NSString, NSTextField, NSTimer, WebWrapScrollView;
