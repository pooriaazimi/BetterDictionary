...
- (id)objectByApplyingXSLTForParentalControl:(id)arg1;
- (void)specifyCSS:(int)arg1 forDictionary:(id)arg2;
- (void)specifyPronunciationCSSForDictionary:(id)arg1;
- (BOOL)embedDictionaryContents:(id)arg1 newDictionary:(BOOL)arg2;
...
- (id)_cachedURL:(unsigned long)arg1 forDictionary:(id)arg2;
@end
